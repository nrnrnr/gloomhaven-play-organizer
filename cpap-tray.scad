...
difference () {
  ...
  theta = asin(wall_thickness/(extension+depth));
  echo (theta=theta);
  translate([outside_corner_radius+wall_thickness,outside_corner_radius+wall_thickness,wall_thickness])
  above(0)
